...
if  socket.gethostname() == 'vm-ywcs03':
    filename_info="/hskj/web/apache/htdocs/YysBill/info.log"
    filename_error="/hskj/web/apache/htdocs/YysBill/error.log"
else:
    filename_info="E:\workspace\YysBill\info.log"
    filename_error="E:\workspace\YysBill\error.log"
...
def connDB():
    conn=  pymysql.connect(host='192.168.120.12',user='root',passwd='123456',db='data_handle',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB1():
