...
if  socket.gethostname() == 'hskj-backup250':
    filename_info="/hskj/web/apache/htdocs/DetailedList/info.log"
    filename_error="/hskj/web/apache/htdocs/DetailedList/error.log"
else:
    filename_info="E:\workspace\DetailedList\info.log"
    filename_error="E:\workspace\DetailedList\error.log"
